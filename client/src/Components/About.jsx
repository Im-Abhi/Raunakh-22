...
const About = () => {
    return (
        <>
            <div className="about__container px-4">
                ...
                <div className="grid grid-cols-3 gap-5">
                    <div class="flex justify-center text-center">
                        <div class="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div class="p-6">
                                <h5 class="text-gray-900 text-xl font-medium mb-2">What is Raunakh?</h5>
                    ...
                    <div class="flex justify-center text-center">
                        <div class="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div class="p-6">
                                <h5 class="text-gray-900 text-xl font-medium mb-2">What does it do?</h5>
                                <p class="text-gray-700 text-base mb-4">
                    ...
                    <div class="flex justify-center text-center">
                        <div class="rounded-lg shadow-lg bg-white max-w-sm">
                            ...
                            <div class="p-6">
                                <h5 class="text-gray-900 text-xl font-medium mb-2">Why do we do this?</h5>
                                <p class="text-gray-700 text-base mb-4">
